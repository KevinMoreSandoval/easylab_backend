...
import curso_integrador.easylab_backend.service.JwtService;
...
/**
 * Filtro que intercepta cada request HTTP para validar el JWT.
 *
 * Si el header Authorization contiene un Bearer token válido,
